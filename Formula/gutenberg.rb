class Gutenberg < Formula
  ...
  test do
    ...
    (testpath/"mysite/content/blog/index.md").write <<-EOS.undent
      +++
      +++

      Hi I'm Homebrew.
    EOS
    (testpath/"mysite/templates/page.html").write <<-EOS.undent
      {{ page.content | safe }}
    EOS
    ...
    assert_equal "<p>Hi I'm Homebrew.</p>\n",
      (testpath/"mysite/public/blog/index.html").read.chomp
  end
end
